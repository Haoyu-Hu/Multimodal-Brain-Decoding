...
def parameter_parser():
    ...
    parser.add_argument('--token_embed_size_clip', type=int, default=512, help='size of a text embedding feature')

    parser.add_argument('--img_embed_size', type=int, default=512, help='size of an image embedding feature')

    parser.add_argument('--token_embed_size_gtr', type=int, default=768, help='size of a text embedding feature')
    ...
    # Decoder -> Img
    parser.add_argument("--decoder_img", type=str, default='stabilityai/stable-diffusion-2-1-unclip')
